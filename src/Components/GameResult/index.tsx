    ...
    <>
      <div className="flex justify-center items-center mb-[62px] gap-[30px]">
        <div className="flex flex-col justify-center items-center">
          <img
            className="w-full h-full mobile:max-w-[130px] max-w-[79px] rounded-full cursor-pointer"
            src={
              rockState
                ? Rock
                : paperState
          ...
          />
          <h1 className="text-[11px] font-[700] leading-[16px] tracking-[1.88px] text-[#FFF] text-center h-[32px]">
            YOU PICKED
          </h1>
        </div>
        <div className="flex flex-col justify-center items-center">
          <img
            ...
            src={housePick}
          />
          <h1 className="text-[11px] font-[700] leading-[16px] tracking-[1.88px] text-[#FFF] text-center w-[84px] ">
            THE HOUSE PICKED
          </h1>
        </div>
      </div>
